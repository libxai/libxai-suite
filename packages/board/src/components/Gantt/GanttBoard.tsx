  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* v0.17.197: Resize handle column - full height with buttons in header area only */}
        <div
        ...
        >
          {/* Resize handle - full height draggable border */}
          <div
            className="cursor-col-resize hover:bg-blue-500/20 transition-colors flex flex-col"
            style={{
              width: 5,
              backgroundColor: theme.bgPrimary,
          ...
          >
            {/* Header area matching the grid header */}
            <div style={{ height: '48px', backgroundColor: theme.bgGrid }} />
          </div>
          ...
          >
            ...
            {/* Empty area below buttons - fills remaining height with background */}
