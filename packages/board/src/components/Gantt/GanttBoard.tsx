...
// v0.17.199: ColumnManager and Keyboard moved back to TaskGrid
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* v0.17.199: Simple resize handle - just the draggable border, buttons stay in TaskGrid scroll area */}
        <div
