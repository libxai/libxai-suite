...
import { ColumnManager } from './ColumnManager'; // v0.17.199: Back in TaskGrid header
...
export function TaskGrid({
  ...
  const [showKeyboardHelp, setShowKeyboardHelp] = useState(false); // v0.17.199: Back in TaskGrid
  const editInputRef = useRef<HTMLInputElement>(null);
  const keyboardHelpRef = useRef<HTMLDivElement>(null); // v0.17.199
  ...
  // v0.17.199: Close keyboard help when clicking outside
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* v0.17.199: Action buttons at the end of header - inside TaskGrid to match row styling */}
        <div
          className="flex items-center gap-1 px-1 flex-shrink-0"
