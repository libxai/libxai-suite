...
// v0.17.195: ColumnManager moved to GanttBoard to sync with resize handle
...
export function TaskGrid({
  ...
  return (
    ...
    >
      ...
      >
        {/* v0.17.195: Action buttons moved to GanttBoard - they now move with the resize handle */}
