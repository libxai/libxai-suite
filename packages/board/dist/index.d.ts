...
interface ListViewCallbacks {
    ...
    onBulkFill?: (taskIds: string[], column: FillColumn, value: any) => void;
}
/**
 ...
 */
type FillColumn = 'assignees' | 'startDate' | 'endDate' | {
    kind: 'customField';
    fieldId: string;
};
/**
